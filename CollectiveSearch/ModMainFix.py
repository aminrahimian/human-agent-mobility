...
class Grid:
    ...
    def crea_targets(self, target_location = None):
        self.size = 1
...
def main_timeana(params, tick_speed, hdf5_filename, case_id, target_locations = None):
    radiuss = params[3]
    tc = params[0]
    mono = params[1]
    beta = params[2]
    ...
    grid = Grid(radiuss, tc, mono, beta, l, a, rho, Rv)
    grid.crea_targets(target_locations)
